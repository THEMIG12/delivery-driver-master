...
[System.Serializable]
public class GhostCarDataItem : ISerializationCallbackReceiver
{
    ...
    public GhostCarDataItem(Vector2 position_, float rotation_, Vector3 localScale_, float timeSinceLevelLoaded_)
    {
        position = position_;
        rotationZ = rotation_;
